...
INSERT INTO tbAluno
VALUES 	(1,'Kaique','2006-02-12','0228789289-58','Brasil-São Paulo-SP'),
		(2,'Done','1997-03-18','4451252369-68','Brasil-São Paulo-SP'),
		(3,'Thayane','1990-05-18','434343545-58','Brasil-São Paulo-SP'),
		(4,'Mauricio','1973-07-23','14415666289-88','Brasil-São Paulo-SP'),
		(5,'Francisco','1975-01-13','8885589289-9','Brasil-São Paulo-SP'),
		(6,'Clayton','1965-07-05','3931783228-76','Brasil-São Paulo-SP'),
		(7,'Everson','1988-06-28','7130398613-58','Brasil-São Paulo-SP'),
		(8,'Rodrigo','1989-12-31','713472378613-94','Brasil-São Paulo-SP'),
		(9,'Robson','1988-08-13','8599212113-29','Brasil-São Paulo-SP'),
		(10,'Wellida','1985-06-28','432984763613-09','Brasil-São Paulo-SP');
...
VALUES 	(1,'Python','60h','R$800.00'),
		...
		(7,'Lógica de Programação','14h','R$200.00'),
		(8,'TIC','14h','R$200.00'),
